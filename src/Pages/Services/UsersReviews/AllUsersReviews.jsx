...
const AllUsersReviews = ({ singleReview }) => {
  const { name, img, review } = singleReview;

  return (
    <div className="container mx-auto mt-8 flex w-full max-w-lg flex-col divide-y divide-gray-700 rounded-md p-6 dark:dark:bg-gray-800 dark:dark:text-gray-100">
      ...
      <div className="space-y-2 p-4 text-sm dark:dark:text-gray-400">
        <p>{review}</p>
      </div>
    </div>
  );
